...
docker run --name my-radius-1 -d -p 1812:1812/udp -p 1813:1813/udp -v $(pwd)/Free_Radius/clients.conf:/etc/raddb/clients.conf -v $(pwd)/Free_Radius/proxy.conf:/etc/raddb/proxy.conf freeradius/freeradius-server
